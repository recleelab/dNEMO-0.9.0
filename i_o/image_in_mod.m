function [I,T,Z,image_filename] = image_in_mod(user_filename,user_filepath)
...
switch file_type
    ...
    case 'tif'
        ...
        if size(I,3) == 1
            ...
            % MODIFICATION - MEANT TO OPEN IMAGES WITHOUT USER INPUT
            % utilize guess_z_slices()
            %{
...
assignin('base','likely_z_dist',likely_z_dist);

% MODIFICATION - MEANT TO JUST OPEN IMAGES w/OUT USER INPUT...making
% adjustments to accomadate that.
%{
