function [] = exclude_signals(APP)
%% 
%  main code for excluding signals as decided by the user
%  display_listener.m handles string swap, method only called by display_call.m
...
if is_click_valid && ~isempty(displayed_centroids)
	...
	if start_point(1,1) == end_point(1,1) && start_point(1,2) == end_point(1,2)
		...
		[closest_ind,closest_dist] = dsearchn(displayed_centroids(:,1:2),[start_point(1,1) start_point(1,2)]);
