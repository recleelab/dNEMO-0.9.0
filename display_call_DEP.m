...
switch process_check
	case 0
		...
		if value_check(1,1)
			...
			color1 = APP.ax2.Color;
			assignin('base','color_after_signal_display',color1);
		end
		
		% cells
		if value_check(2,1) && toggle_check(3,1)
			display_cells(APP,value_check(3,1));
			color2 = APP.ax2.Color;
			assignin('base','color_after_cell_display',color2);
		end
		...
		if value_check(1,1) && value_check(2,1)
			...
			color3 = APP.ax2.Color;
			assignin('base','color_after_2ndary_info',color3);
		end
